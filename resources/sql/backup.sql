;             
CREATE USER IF NOT EXISTS SA SALT '40e2e110a24158a0' HASH '7b1687064ce6820823caa1f94e68accf844b7a07d9ec249c86b0190edd4abda1' ADMIN;           
CREATE DOMAIN GENDER AS VARCHAR DEFAULT ('MALE', 'FEMALE');   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_0ACB6E31_EC45_4118_B5DD_F916F2DA70BC START WITH 13 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A689859F_EFE8_465A_9321_6FA90268F1C3 START WITH 17 BELONGS_TO_TABLE;   
CREATE SEQUENCE PUBLIC.SYSTEM_SEQUENCE_CEA874A3_0B1C_4E5E_8D1A_60B75675F339 START WITH 8 BELONGS_TO_TABLE;    
...
-- 10 +/- SELECT COUNT(*) FROM PUBLIC.CLIENTS;
...
(6, 'Anna', 'anna@gmail.com', '+380661236547', 3, 'FEMAIL', NULL),
